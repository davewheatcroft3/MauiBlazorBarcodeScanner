...
public interface IBlazorWebViewPermissionsManager
{
    WebChromeClient SetWebView(WebChromeClient webChromeClient);

    void SetActivity(ComponentActivity activity);
}

internal class PermissionManager : WebChromeClient, IActivityResultCallback, IBlazorWebViewPermissionsManager
{
    ...
    private WebChromeClient _blazorWebChromeClient;
    private ComponentActivity _activity;
    private ActivityResultLauncher _requestPermissionLauncher;
    ...
    public WebChromeClient SetWebView(WebChromeClient webChromeClient)
    {
        _blazorWebChromeClient = webChromeClient;
        return this;
    }
